...
add_action( 'init', 'create_effigylabs_publications', 0 );

function create_effigylabs_publications() {
    
	$singularUpperCase = 'Publication';
	$cptSlug = 'publication';
	$singularLowerCase = 'publication';
	$pluralUpperCase = 'Publications';
	$pluralLowerCase = 'publications';
    ...
    $labels = 	array(
      ...
      create_effigylabs_publication_categories( $cptSlug );
      
    }
    
    
// hook into the init action and call create_book_taxonomies when it fires
add_action( 'init', 'create_effigylabs_publication_categories', 0 );

// create two taxonomies, genres and writers for the post type "book"
function create_effigylabs_publication_categories( $cptSlug ) {
