...
$acfLocations = list_all_cpts();
$acfModules = list_all_module_names();

//var_dump($acfLocations);

acf_add_local_field_group(array (
	'key' => 'group_588986f811cb2',
	'title' => 'URL Redirect',
	'fields' => array (
		array (
			'key' => 'field_5889870ec6847',
			'label' => 'Redirect',
			'name' => 'redirect',
			'type' => 'url',
			'instructions' => 'Redirect this page to the following URL',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
...
acf_add_local_field_group(array (
	'key' => 'group_588e67859a980',
	'title' => 'Content Blocks',
	'fields' => array (
		array (
			'key' => 'field_588e67a0fb833',
			'label' => 'Content Block',
			'name' => 'content_block',
			'type' => 'repeater',
			'instructions' => '',
			...
			'sub_fields' => array (
				...
				array (
					'key' => 'field_588e682ffb836',
					'label' => 'Section Title',
					'name' => 'content_block_title',
					'type' => 'text',
					'instructions' => 'OPTIONAL: This is helpful for identifying backend content, especially if the page gets long. Use Section Settings to optionally show it on the front-end.',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '',
				...
				array (
					...
					'sub_fields' => array (
						array (
							'key' => 'field_589c474fda2ea',
							'label' => 'Column Width',
							'name' => 'column_width',
							'type' => 'select',
							'instructions' => 'Select a column width',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array (
								'width' => '25',
						...
						array (
							'key' => 'field_58e19e145b3e1',
							'label' => 'Choose a Content Type',
							'name' => 'choose_a_content_type',
							'type' => 'select',
							...
							// INSERT LIST OF CUSTOM MODULES AS CHOICES
//							'choices' => array (
//								'Content' => 'Content',
//								'Gallery' => 'Gallery',
//								'Icon Boxes' => 'Icon Boxes',
//								'Remote News Carousel' => 'Remote News Carousel',
//								'Accordion' => 'Accordion',
...
//							),
						...
						array (
							'key' => 'field_58e1b59c2e8f7',
							'label' => 'Custom Class',
							'name' => 'custom_class',
							'type' => 'text',
							'instructions' => 'Add Custom Classes to this content',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array (
								'width' => '25',
						...
						array (
							'key' => 'field_589c47d3da2ec',
							'label' => 'Column Last',
							'name' => 'column_last',
							'type' => 'checkbox',
							'instructions' => 'Last column in this row?',
							'required' => 0,
							'conditional_logic' => 0,
							'wrapper' => array (
								'width' => '25',
						...
						/*
						* INSERT CUSTOM MODULE FIELDS HERE 
						*/
						
					),
				),
				array (
					'key' => 'field_5907abf196ebc',
				...
				array (
					'key' => 'field_5907c0b46b29f',
					'label' => 'Section ID',
					'name' => 'section_id',
					'type' => 'text',
					'instructions' => 'OPTIONAL: Add an ID to this section',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '20',
				...
				array (
					'key' => 'field_58a4f27a91ee1',
					'label' => 'Make Fullwidth?',
					'name' => 'fullwidth',
					'type' => 'true_false',
					'instructions' => 'Make this section full width of screen?',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '20',
				...
				array (
					'key' => 'field_58e1a4440e223',
					'label' => 'Show Section Title?',
					'name' => 'show_content_title',
					'type' => 'true_false',
					'instructions' => 'Show the Content Title on the Frontend.',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '20',
				...
				array (
					'key' => 'field_58e1a4440e223b',
					'label' => 'Move Section Title?',
					'name' => 'move_content_title',
					'type' => 'true_false',
					'instructions' => 'Move the Content Title into content area.',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '20',
				...
				array (
					'key' => 'field_5907c2166b2a0',
					'label' => 'Add Text Anchor',
					'name' => 'content_block_anchor',
					'type' => 'true_false',
					'instructions' => 'Adds a scrolling link to top of page.',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '20',
				...
				array (
					'key' => 'field_5907b4b38727f',
					'label' => 'Section Custom Spacing',
					'name' => 'section_custom_spacing',
					'type' => 'repeater',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
					...
					'max' => 0,
					'layout' => 'table',
					'button_label' => 'Add More Custom Spacing',
					'sub_fields' => array (
						array (
							'key' => 'field_5907b4cd87280',
							'label' => 'Custom Spacing Type',
							'name' => 'custom_spacing_type',
							'type' => 'select',
							'instructions' => '',
							'required' => 1,
							'conditional_logic' => 0,
						...
						array (
							'key' => 'field_5907b97b85877',
							'label' => 'Custom Spacing Side',
							'name' => 'custom_spacing_side',
							'type' => 'select',
							'instructions' => '',
							'required' => 1,
							'conditional_logic' => 0,
						...
						array (
							'key' => 'field_5907b57787281',
							'label' => 'Custom Spacing Size',
							'name' => 'custom_spacing_size',
							'type' => 'select',
							'instructions' => '',
							'required' => 1,
							'conditional_logic' => 0,
				...
				array (
					'key' => 'field_5907b873ab6af',
					'label' => 'Custom Background Colour',
					'name' => 'custom_bg_colour',
					'type' => 'select',
					'instructions' => 'Choose a background colour for this section.',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '33',
					...
					'choices' => array (
						...
						'bg-tuna' => 'Dark Gray',
						'bg-theme' => 'Theme Colour',
						'bg-primary' => 'Theme Primary Colour',
						'bg-secondary' => 'Theme Secondary Colour',
						'bg-tertiary' => 'Theme Tertiary Colour',
					),
					'default_value' => array (
					),
					'allow_null' => 1,
				...
				array (
					'key' => 'field_5907cd2b26df3',
					'label' => 'Custom Text Colour',
					'name' => 'custom_text_colour',
					'type' => 'select',
					'instructions' => 'Choose a background colour for this section.',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array (
					'key' => 'field_588e69539caaa',
					'label' => 'Additional Custom Classes',
					'name' => 'content_block_class',
					'type' => 'text',
					'instructions' => 'Add a custom classes to this block (optional)',
					'required' => 0,
					'conditional_logic' => 0,
					'wrapper' => array (
						'width' => '34',
